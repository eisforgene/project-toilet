...
db.once('open', async () => {
    ...
    const toilets = await Toilet.insertMany([
        ...
        {zipcode: '94941', coordinates: '37.875146X-122.531700' , lat: '37.875146', lng: '-122.531700'},
        {zipcode: '94941', coordinates: '37.880579X-122.540161', lat: '37.880579', lng: '-122.540161'}
    ]);
